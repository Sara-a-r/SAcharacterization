...
def matrix(M1, M2, M3, M4, M5, K1, K2, K3, K4, K5, g2, g3, g4, g5, dt):
    ...
    B = np.array((dt/M1,0, dt/M3, 0, 0, 0, 0, 0, 0, 0))
    return A, B
...
def evolution(evol_method, Nt_step, dt, physical_params, ref, kp, ki, kd, file_name = None):
    ...
    err_t1, err_t3 = [] , []   # list for memorizing the value of the error
    I1, I3 = 0, 0
    j = 0                      # cycle index
    ...
    for t in tt:
        ...
        u = np.array((Fc1, 0, Fc3, 0, 0, 0, 0, 0, 0, 0))
...
if __name__ == '__main__':
    ...
    control_params_PID = [ref, (30, 300), (10, 100), (30, 300)]    # ref, kp, ki, kd
    ...
    plt.title('PID control for five coupled oscillators (M$_1$, M$_3$) \n x$_1^{ref}$=%.1f, k$_p$=(%.1f,%.1f), k$_i$=(%.1f,%.1f), k$_d$=(%.1f,%.1f)'
              %(control_params_PID[0], control_params_PID[1][0], control_params_PID[1][1],
                control_params_PID[2][0], control_params_PID[2][1], control_params_PID[3][0], control_params_PID[3][1]), size=11)
